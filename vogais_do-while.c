...
//A intenção do seguinte programa é dizer quantas vogais tem em um nome, utilizando (agora) do e while.
...
void main() { // Aqui é criada a função main, do tipo void.
    ...
    while(nome[count] != '\0'); // Aqui é declarada a condição para continuação do loop após o do.
